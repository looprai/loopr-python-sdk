...
.. py:class:: Dataset()
   ...
   .. py:method:: add_row(self, data: dict, external_id: str = None, **kwargs)
    ...
    .. code-block:: python
        ...
        image_row_with_query = image_dataset.add_row(data={"image":"gs://loopr-demo-dataset/a61a69be-f152-4175-bab4-e119f980bc3d", "query": "query"})
